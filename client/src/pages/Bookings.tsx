...
function Bookings() {
    ...
    useEffect(() => {
        ...
        if (button === "tomorrow") {
            ...
            selectedClasses = initialClasses.filter((item) => {
                return (
                    item.classDate >= tomorrow() &&
                    item.classDate <= dayAfterTomorrow()
                )
            })
        }
        if (button === "nextWeek") {
            ...
            selectedClasses = initialClasses.filter((item) => {
                return (
                    item.classDate >= nextMonday() &&
                    item.classDate <= secondMonday()
                )
            })
        }

...
export default function GymClassItem (post:Post) {
    ...
    const { setFavorites, userId, favoriteGymClassDetails, favorites } = useGymClass();
                ...
                <div className="flex flex-col gap-5 bg-[#6F87F5] w-[60%]">
                    ...
                    <div className="flex justify-between mb-4">
                        ...
                        <button className="flex w-10 h-10 mr-4" onClick={handleClick}>
                            <img src={isFavorite(favoriteGymClassDetails, id) ? "/heart-red.svg" : "/heart-white.svg"} alt="heart"/>
                        </button>
                    </div>
                </div>
            </article>

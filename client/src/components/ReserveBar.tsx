...
export default function ReserveBar() {
  ...
  return (
    <footer className="flex justify-around py-3 border-t-[1px] shadow-[0_8px_10px_-7px_rgba(0,0,0,0.4)_inset]">
       ...
       <ReserveButton buttonText={isAuthenticated? 'LOGIN TO RESERVE' : 'RESERVE'} backgroundColor='#6F87F5' textColor='#FFF' hoverBackgroundColor="#269FAE" hoverTextColor="#fff" nav={handleReserve}/>
    </footer>
  )
}